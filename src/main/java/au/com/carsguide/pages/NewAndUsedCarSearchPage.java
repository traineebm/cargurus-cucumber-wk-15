...
public class NewAndUsedCarSearchPage extends Utility {
    ...
    public void selectCarModelFromDropDown(String model) {
        selectByValueFromDropDown(getCarModels, model);
        log.info("Click on Car Model: " + getCarModels.toString());
    }

    public void selectLocationFromDropDown(String loc) {
        selectByValueFromDropDown(getLocations, loc);
    ...
    public String iShouldSeeTheMakeInResults() {
        log.info("Getting car make in search results: " + carMakeResult.toString());
        return getTextFromElement(carMakeResult);
    }
